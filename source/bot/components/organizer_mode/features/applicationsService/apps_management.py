...
from components.organizer_mode.features.applicationsService.fsm_states import ApplicationStates
from components.organizer_mode.features.applicationsService.prefixes import ApplicationPrefixes
from components.organizer_mode.features.applicationsService.keyboards import (kb_change_status, kb_change_app,
...
async def cb_om_application_menu(callback: CallbackQuery | Message, bot: Bot, state: FSMContext) -> None:
    await state.clear()
...
async def cb_om_application_list(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_approve(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_reject(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_delete_start(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_delete_confirm(message: Message, bot: Bot, state: FSMContext) -> None:
    kb = InlineKeyboardMarkup(inline_keyboard=[])
    try:
...
async def cb_om_application_delete_final(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_delete_cancel(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_edit_start(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_edit_choose_field(message: Message, bot: Bot, state: FSMContext) -> None:
    kb = InlineKeyboardMarkup(inline_keyboard=[])
    try:
        app_id = int(message.text)
...
async def cb_om_application_edit_get_value(callback: CallbackQuery, bot: Bot, state: FSMContext) -> None:
...
async def cb_om_application_edit_finish(message: Message, bot: Bot, state: FSMContext) -> None:
