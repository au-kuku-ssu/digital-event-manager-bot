...
async def pr_cb_main(callback_query: types.CallbackQuery, bot: Bot) -> None:
  lang = "ru"
  prefix = "participant_registration.user.main"
  shared = "participant_registration.shared"

  keyboard = InlineKeyboardBuilder()
  keyboard.button(text=getstr(lang, prefix, "browse"), callback_data="pr_cb_user_browse")
  keyboard.button(text=getstr(lang, prefix, "search"), callback_data="pr_cb_user_search")
  keyboard.button(text=getstr(lang, prefix, "my_activities"), callback_data="pr_cb_user_my_activities")
  keyboard.button(text=getstr(lang, prefix, "my_data"), callback_data="pr_cb_user_my_data")
